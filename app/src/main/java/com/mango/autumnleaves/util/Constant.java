...
public class Constant {
    ...
    public static final String KEY_SESSION_MAHASISWA_TEMPAT_LAHIR = "KEY_SESSION_MAHASISWA_TEMPAT_LAHIR";
    ...
    public static final String KEY_SESSION_MAHASISWA_TGL_LAHIR = "KEY_SESSION_MAHASISWA_DEVICE";
